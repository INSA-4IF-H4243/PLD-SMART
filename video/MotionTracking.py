...
videoPath='dataset/clip_masterclass/clip22.mp4'#chemin de la video
...
#JOUEUR BAS
model_bas = ModelJoueurClassique.load_model_from_path("saved_models/model_classic_Jiaqi_bas_deplacement.h5")
