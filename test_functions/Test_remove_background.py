...
stream = cv2.VideoCapture("../dataset/service_j1/cut2_5n4Utu0k.mp4")
...
print(num_frames)
frame_ids = np.random.uniform(size=30) * num_frames
frames = []
...
output = cv2.VideoWriter("../video_output/output_test.mp4",
